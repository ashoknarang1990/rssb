...
class Pillars extends CI_Controller {
	...
	public function __Construct(){
		...
		$this->load->model(array('pillars_model','common_model'));
	}
	
	public function index() {
		$return['header_page_id'] = 'pillars';
		$return['header_page_title'] = 'Manage Pillars';
		$this->load->view('user/pillars',$return);
